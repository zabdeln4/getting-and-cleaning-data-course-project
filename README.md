...
- `CodeBook.md`, the code book, which describes the contents of the data set (generated automaticly using `codebook` R package).
...
The `tidy_data.txt` in this repository was created by running the `run_analysis.R` script using R version 4.0.0 on Windows 10 64-bit edition.
